...
exports.browsePGroup= asyncHandler(async (req, res) => {
    try {
      ...
      await sql
        ...
        .then((pool) => {
          return pool
            ...
            .execute("list_pgroup_master_new ");
        })
        .then((result) => {
          const data =
  ...
  exports.insertPGroup= asyncHandler(async (req, res) => {
    try {
  ...
  exports.deletePGroup= asyncHandler(async (req, res) => {
    try {
  ...
  exports.previewPGroup= asyncHandler(async (req, res) => {
    try {
