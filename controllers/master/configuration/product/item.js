...
exports.browseItem= asyncHandler(async (req, res) => {
    try {
  ...
  exports.insertItem= asyncHandler(async (req, res) => {
    try {
  ...
  exports.previewItem= asyncHandler(async (req, res) => {
    try {
