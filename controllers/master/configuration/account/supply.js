...
exports.browseSupply= asyncHandler(async (req, res) => {
    try {
  ...
  exports.insertSupply= asyncHandler(async (req, res) => {
    try {
  ...
  exports.previewSupply= asyncHandler(async (req, res) => {
    try {
