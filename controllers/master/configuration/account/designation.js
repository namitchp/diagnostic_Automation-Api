      ...
      await sql
        ...
        .then((pool) => {
          return pool
            ...
            .execute("browse_designation_new ");
        })
        .then((result) => {
          const data =
    ...
    try {
      ...
      await sql
        ...
        .then((pool) => {
          ...
          .output("new_identity")
            .execute("insert_designation_master ");
        })
        .then((result) => {
    ...
    try {
      ...
      await sql
        ...
        .then((pool) => {
          return pool
            .request()
          .input("designationId",req.body.designation_id)
            .execute("preview_designation");
        })
        .then((result) => {
